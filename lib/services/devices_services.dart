...
class DevicesServices {
  ...
  Future<List<Map<String, dynamic>>> getDevices({required String userID, required String token}) async {
    ...
    final Map<String, dynamic> data = await _apiRequest.get(route: _apiRoutes.getDevices,
  ...
  Future <Map<String, dynamic>?> updateSKDeviceName({required String token, required String deviceID, required Map<String,dynamic> sinkName})async{
    ...
    final Map<String,dynamic> data = await _apiRequest.patch(route: _apiRoutes.updateSKName,
  ...
  Future <Map<String, dynamic>?> updateSNDeviceName({required String token, required String deviceID, required String sensorName})async{
    String? accessToken;
    TokenStatus accessStatus = await _authUtils.verifyToken(token: token);
    ...
    final Map<String,dynamic> data = await _apiRequest.put(route: _apiRoutes.updateSKName,
